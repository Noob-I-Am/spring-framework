...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<context:component-scan base-package="org.max.web"/>
...
----
	...
	@ControllerAdvice("org.max.controllers")
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean id="conversionService"
			...
			<property name="converters">
				<set>
					<bean class="org.max.MyConverter"/>
				</set>
			</property>
			<property name="formatters">
				<set>
					<bean class="org.max.MyFormatter"/>
					<bean class="org.max.MyAnnotationFormatterFactory"/>
				</set>
			</property>
			<property name="formatterRegistrars">
				<set>
					<bean class="org.max.MyFormatterRegistrar"/>
				</set>
			</property>
		</bean>
...
----
	<mvc:interceptors>
		...
		<mvc:interceptor>
			...
			<bean class="org.max.SecurityInterceptor"/>
		</mvc:interceptor>
	</mvc:interceptors>
----
...
----
	...
	<bean id="pathHelper" class="org.max.app.MyPathHelper"/>
	<bean id="pathMatcher" class="org.max.app.MyPathMatcher"/>
----
