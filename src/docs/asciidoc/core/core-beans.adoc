...
----
	@Configuration
	@ComponentScan(basePackages = "org.max")
...
annotation, i.e. `@ComponentScan("org.max")`
====
...
----
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<context:component-scan base-package="org.max"/>
...
----
	@Configuration
	@ComponentScan(basePackages = "org.max", nameGenerator = MyNameGenerator.class)
	public class AppConfig {
		...
	}
----
...
----
	<beans>
		<context:component-scan base-package="org.max"
			name-generator="org.max.MyNameGenerator" />
	</beans>
----
...
----
	@Configuration
	@ComponentScan(basePackages = "org.max", scopeResolver = MyScopeResolver.class)
	public class AppConfig {
		...
	}
----
...
----
	<beans>
		<context:component-scan base-package="org.max" scope-resolver="org.max.MyScopeResolver"/>
	</beans>
----
...
----
	@Configuration
	@ComponentScan(basePackages = "org.max", scopedProxy = ScopedProxyMode.INTERFACES)
	public class AppConfig {
		...
	}
----
...
----
	<beans>
		<context:component-scan base-package="org.max" scoped-proxy="interfaces"/>
	</beans>
----
